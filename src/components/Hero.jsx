...
export default function Hero() {
    ...
    // [WEBINAR MODAL] State untuk modal info webinar belum dibuka.
    // Untuk menonaktifkan modal ini (saat webinar sudah dibuka):
    //   1. Hapus/komen baris state showWebinarModal di bawah
    //   2. Hapus/komen seluruh blok modal {showWebinarModal && (...)} di JSX
    //   3. Ganti <button onClick={...}> kembali ke <a href="#webinar" ...>
    //   4. tanda <> awal dan akhir juga dihapus
        ...
        <>
            <section id="home" className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                        ...
                        {/* [WEBINAR BELUM DIBUKA] Tombol ini membuka modal info.
                            Saat webinar sudah dibuka, ganti seluruh <button> ini dengan:
                    ...
                    <div className="max-w-2xl mx-auto glass-card p-6 rounded-2xl shadow-2xl border border-slate-700/60">
                        <h3 className="text-xs uppercase tracking-widest text-slate-400 font-semibold mb-4">Penutupan Pendaftaran Lomba Gelombang 2 dalam</h3>
            ...
            {showWebinarModal && (
                ...
                >
                    ...
                    {/* Modal Card */}
                    <div
                        className="relative w-full max-w-md rounded-2xl border border-slate-700/80 bg-slate-900 shadow-2xl overflow-hidden"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Top accent bar */}
                        <div className="h-1 w-full bg-gradient-to-r from-brand-orange via-brand-gold to-brand-lime"></div>

                        <div className="p-6 sm:p-8">
                            {/* Icon */}
                            <div className="flex items-center justify-center w-16 h-16 mx-auto mb-5 rounded-2xl bg-brand-skyblue/10 border border-brand-skyblue/20">
                                <i className="fa-solid fa-video text-3xl text-brand-skyblue"></i>
                            </div>
                            ...
                            <p className="text-brand-amber font-semibold text-xs text-center uppercase tracking-widest mb-5">
                                FESTAFORA 2026
                            </p>

                            {/* Message */}
                            <div className="bg-slate-800/60 border border-slate-700/60 rounded-xl p-4 mb-6 text-center">
                                <p className="text-slate-200 text-sm leading-relaxed">
                                    Pendaftaran Webinar <span className="text-brand-gold font-bold">belum dibuka</span> saat ini.
                                </p>
                                <p className="text-slate-400 text-xs mt-2 leading-relaxed">
                                    Pantau terus informasi resmi kami di media sosial <span className="text-white font-semibold">festafora2k26</span> untuk mendapatkan update terbaru.
                                </p>
                            </div>
                            ...
                            <button
                                onClick={() => setShowWebinarModal(false)}
                                className="w-full py-3 rounded-xl bg-gradient-to-r from-brand-orange to-brand-gold text-slate-950 font-bold text-sm hover:scale-[1.02] transition-all"
                            >
                                Oke, Siap!
                            </button>
                        </div>
